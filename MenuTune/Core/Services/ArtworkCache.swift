...
/// Simple artwork cache: in-memory NSCache for NSImage and on-disk binary store for Data.
final class ArtworkCache {
    ...
    private lazy var baseURL: URL = {
        ...
        let dir = caches.appendingPathComponent("com.hieunt0220.MenuTune/artwork", isDirectory: true)
